              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', width: '100%' }}>
                ...
                >
                  ...
                  <Link external href={getPoolLink(token0?.id, token1?.id)}>
                    <ButtonLight color={backgroundColor}>+ {isZH ? '增加流动性' : 'Add Liquidity'}</ButtonLight>
                  </Link>
            ...
            <>
              ...
              <PanelWrapper style={{ marginTop: '1.5rem' }}>
                <Panel style={{ height: '100%' }}>
                  <AutoColumn gap="20px">
                    <RowBetween>
                      <TYPE.main>{isZH ? '总流动资产' : 'Total Liquidity'} {!usingTracked ? '(Untracked)' : ''}</TYPE.main>
                      <div />
                    </RowBetween>
                ...
                <TokenDetailsLayout>
                  ...
                  <Column>
                    <TYPE.main>
                      <RowFixed>
                        <FormattedName text={token0?.symbol ?? ''} maxCharacters={8} />{' '}
                        <span style={{ marginLeft: '4px' }}>{isZH ? '地址' : 'Address'}</span>
                      </RowFixed>
                    </TYPE.main>
                    <AutoRow align="flex-end">
                      <Text style={{ marginTop: '.5rem' }} fontSize={16} fontWeight="500">
